...
in the loop). Used by sync_listings_kpis.py here and by the sibling
wheelhouse-reservations-sync skill's script.
...
/listings/{listing_id}/reservations is the one path in this codebase that's
